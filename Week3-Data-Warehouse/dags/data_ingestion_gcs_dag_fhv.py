...
#FHV_TAXI_GCS_PATH_TEMPLATE = "fhv_tripdata/{{ execution_date.strftime(\'%Y\') }}/fhv_tripdata_{{ execution_date.strftime(\'%Y-%m\') }}.parquet"
...
OUTPUT_FILE = "fhv_tripdata{{ execution_date.strftime(\'%Y-%m\') }}.parquet"
